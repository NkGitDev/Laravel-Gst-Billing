                    ...
                    <form class="needs-validation" novalidate="" method="post" action="{{ route('update-party', $party->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="full_name" value="{{ $party->full_name }}" class="form-control border-bottom "
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="mobile_number" value="{{ $party->mobile_number }}" class="form-control border-bottom "
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="account_number" value="{{ $party->account_number }}" class="form-control border-bottom "
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="zip_code" value="{{ $party->zip_code }}" class="form-control border-bottom "
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="state" value="{{ $party->state }}" class="form-control border-bottom "
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="branch_name" value="{{ $party->branch_name }}" class="form-control border-bottom "
