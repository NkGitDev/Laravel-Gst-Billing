                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <!-- Invoice Print Date & Time -->
                                <div class="row pl-2">
                                    <div class="col-12 d-flex justify-content-start">
                                        <label for="">Date & Time: </label>
                                        <span class="m1-1">&nbsp;{{ \Carbon\Carbon::now('Asia/Kolkata')->format('l, j, F, Y, g:i:s A') }}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 border p-0">
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                ...
                                                <span class="m1-1">&nbsp;{{ $bill->party->full_name }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Address : </label>
                                                <span class="m1-1">&nbsp;{{ $bill->party->address }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Phone : </label>
                                                <span class="m1-1">&nbsp;{{ $bill->party->mobile_number }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2 pb-1">
                                            <div class="col-9 d-flex justiy-content-start">
                                                <label for="">State : </label>
                                                <span class="m1-1">&nbsp;{{ $bill->party->state }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 border p-0">
                                        ...
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                ...
                                                <span class="m1-1">&nbsp;{{ $bill->invoice_number }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Invoice Date : </label>
                                                <span class="m1-1">&nbsp;{{ \Carbon\Carbon::parse($bill->invoice_date)->format('d F Y') }}</span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justify-content-start">
                                                <label for="">Invoice Created At : </label>
                                                <span class="m1-1">&nbsp;{{ $bill->created_at->setTimezone('Asia/Kolkata')->format('l, j, F, Y g:i:s A') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6 col-lg-3 mt-1">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><b>Total GST :</b><span class="float-right"><i
                                                        class="fas fa-rupee-sign"></i> {{ $bill->cgst_amount+$bill->sgst_amount+$bill->igst_amount }} </span>
                                            </li>
                                            <li><b>Grand Total :</b><span class="float-right"><i
                                                        class="fas fa-rupee-sign"></i> {{ $bill->total_amount+$bill->cgst_amount+$bill->sgst_amount+$bill->igst_amount }} </span>
                                            </li>
                                        </ul>
                                ...
                                <div class="mt-4 mb-1">
                                    <div class="text-right d-print-none">
                                        ...
                                        <a href="{{ route('manage-gst-bills') }}" class="btn btn-danger waves-effect waves-light">All
                                            Bills <i class="mdi mdi-file-document mr-1"></i></a>
                                    </div>
                                </div>
                            </div> <!-- end card-box -->
                        </div> <!-- end col -->
